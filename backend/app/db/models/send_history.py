...
class SendHistory(Base):
    ...
    __table_args__ = (Index("ix_send_history_schedule_sent", "scheduled_message_id", "sent_at"),)
    ...
    status: Mapped[SendStatus] = mapped_column(Enum(SendStatus, name="send_status"), nullable=False)
